...
public class EtcdRegistry implements Registry {
    ...
    @Override
    /**
     * 使用hutool定时任务续约-定时进行重新注册
     * 当代理对象被创建时候会被调用invoke方法,服务会被注册到注册中心（发送请求参数，服务提供端返回响应结果）
     * 提供者注册自己服务到注册中心，默认30秒生命周期
     * 注册中心定时每隔10s 去重新注册，确认服务是否存活
     */
